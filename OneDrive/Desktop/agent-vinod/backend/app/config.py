...
class Settings(BaseSettings):
    ...
    # Admin bootstrap
    admin_bootstrap_org_name: str = "DemoAgent"
    admin_bootstrap_email: str = "admin@demoagent.local"
    admin_bootstrap_password: str = "demo1234"
    ...
    stripe_enterprise_contact_url: str = "mailto:sales@demoagent.local"

    # Uploads / storage
    admin_upload_dir: str = "tmp/admin_uploads"
